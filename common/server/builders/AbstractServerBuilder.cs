...
namespace glowberry.common.server.builders
{
    ...
    public abstract class AbstractServerBuilder : AbstractLoggingMessageProcessing
    {
        ...
        /// </summary>
        public async Task<bool> Build(Section serverSection, string serverType, string serverVersion, string javaRuntime)
        {
            // Try to build the server, returning true if it succeeds.
            try { return await this.InternalBuild(serverSection, serverType, serverVersion, javaRuntime); }
        ...
        private int GenerateEula(Section serverSection)
        {
            ...
            FileUtils.AppendToFile(eulaPath, "# This EULA file was generated by Glowberry.");
            FileUtils.AppendToFile(eulaPath, "# By using glowberry, you automatically agree to the Minecraft TOS - https://aka.ms/MinecraftEULA");
